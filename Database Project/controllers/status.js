...
exports.add ={
    controller: (req, res) => {
        oracledb.getConnection(connAttr, function(err, connection){
            ...
            let query = 'INSERT INTO STATUS(STATUS_ID, STATUS_TITLE) VALUES(:STATUS_ID, :STATUS_TITLE)';
            let binds = [req.body.STATUS_ID ,
...
exports.getStatus = (req, res) => {
    oracledb.getConnection(connAttr, function(err, connection){
        ...
        console.log("Connected to Database")
        let query = "select * from STATUS where STATUS_ID = " + id ;
        connection.execute(query, {}, {}, function(err, result){
            console.log("Executing query...")
            if(err){
                console.log(err);
